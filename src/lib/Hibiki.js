 ...
 * @prop {Collection<Shard>} shards Collection of shards the bot is using
 ...
 * @prop {Collection<GuildChannel>} guildChannels Collection of guild channels the bot is in.
 * @prop {CommandManager} cm Command manager for Hibiki.
 * @prop {Logger} logger Custom logger for Hibiki.
 */
class Hibiki extends EventEmitter {
    /**
     * Create a Client
     * @arg {String} token bot token
     * @arg {Object} opt Hibiki Options.
     ...
     */
    constructor(token, opt, options) {
        if (!opt) throw new Error("Hibiki options aren't specified.");
        super();
        ...
        this.guildChannels = new Collection(GuildChannel);
        this.retryAfters = {};
        this.guildShardMap = {};
        this.sharedStreams = {};
